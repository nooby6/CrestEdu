      ...
      <main>
          ...
          <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 py-12 items-center">
            <div>
              ...
              <div className="mt-6 flex gap-4">
                <a href="#courses" className="px-6 py-3 bg-blue-600 text-white rounded-md shadow-md">Explore Courses</a>
        ...
        <section id="courses" className="py-12">
          <div className="container">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: 'Primary Tuition', desc: 'Foundations in literacy, numeracy and sciences with activity-led lessons.' },
                { title: 'Secondary (KS3/4)', desc: 'Exam-focused coaching and revision plans for KS3 and GCSE.' },
                { title: 'A-Level / IB Support', desc: 'Advanced subject coaching and university preparation.' }
              ].map((course, idx) => (
                <article key={idx} className="bg-white rounded-lg p-6 shadow-sm">
                  <h4 className="font-semibold text-lg">{course.title}</h4>
                  <p className="mt-2 text-gray-600 text-sm">{course.desc}</p>
                  <div className="mt-4">
        ...
        <section id="testimonials" className="py-12">
          <div className="container">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                '“My child improved two grades in maths within three months — the tutors are fantastic.” — Sarah N.',
                '“Engaging lessons and great feedback.” — Michael K.',
                '“Flexible schedules and friendly teachers.” — Amina H.'
              ].map((quote, idx) => (
                <blockquote key={idx} className="bg-white p-6 rounded-lg shadow-sm text-sm text-gray-700">{quote}</blockquote>
              ))}
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="bg-blue-600 text-white py-12">
          <div className="container grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <form className="bg-white text-gray-900 rounded-lg p-6 shadow-sm space-y-4">
