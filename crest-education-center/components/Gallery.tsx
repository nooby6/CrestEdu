...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="py-20 bg-gradient-to-br from-blue-50 to-green-50 dark:from-gray-800 dark:to-gray-900 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Explore our vibrant learning environment where students thrive through engaging activities, 
            collaborative projects, and personalized instruction.
          </p>
        </div>
          ...
          {galleryImages.map((image, index) => (
            <Card 
              ...
              style={{
                ...
                height: index % 3 === 0 ? '300px' : index % 3 === 1 ? '350px' : '280px'
              }}
            >
        ...
        {/* Testimonials */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-12">What Parents Say</h3>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            { icon: BookOpen, title: "15+ Years", subtitle: "Teaching Excellence", color: "from-blue-500 to-blue-600" },
            { icon: Users, title: "500+", subtitle: "Happy Students", color: "from-green-500 to-green-600" },
            { icon: Award, title: "95%", subtitle: "Success Rate", color: "from-purple-500 to-purple-600" },
            { icon: Camera, title: "1000+", subtitle: "Learning Moments", color: "from-orange-500 to-orange-600" }
          ].map((achievement, index) => (
            <div 
              key={index}
              className="text-center transform hover:scale-110 transition-transform duration-300"
            >
              <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${achievement.color} flex items-center justify-center shadow-lg`}>
                <achievement.icon className="w-8 h-8 text-white" />
              </div>
              <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">{achievement.title}</h4>
              <p className="text-gray-600 dark:text-gray-300">{achievement.subtitle}</p>
            </div>
          ))}
        </div>
